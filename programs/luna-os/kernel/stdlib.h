extern void readin(char* buffer, char clrdone, char blind);
extern void puts32(char* str, char fg, char bg);
extern void setup_copy(int sectors, char drive);
extern void save_buffer(char* buffer, char drive);
